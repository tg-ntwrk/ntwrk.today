...
При достижении и/или преодолении sampling aggregate utilization в течении периода нормализации добавится ещё sub-LSP\(s\)*n, с такими-же параметрами \(sub-LSPs наследуют настройки контейнера и во время нормализации происходит распределение bw между всеми sub-LSPs принадлежащими к этому контейнеру\), и будет участвовать в ECMP.
