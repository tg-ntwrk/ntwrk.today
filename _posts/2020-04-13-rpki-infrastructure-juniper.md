...
1. Базовая настройка конфигурации RPKI валидатора:
    ...
    > **Примечание**: Для безопасности необходимо указать адреса интерфейсов, на которых будут работать демоны, настроить фаервол, а также реверс-прокси для доступа по HTTP/HTTPS.
