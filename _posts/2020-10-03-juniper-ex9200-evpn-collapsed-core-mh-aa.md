...
***Часть конфигурации, описывающая адрес lo0.0 интерфейса и фильтрацию для защиты Control Plane*** (рекомендую ознакомится самостоятельно, так как описание фильтров выходит за рамки написания данной заметки):
