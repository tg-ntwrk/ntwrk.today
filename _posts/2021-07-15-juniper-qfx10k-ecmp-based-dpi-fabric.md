...
Поэтому, не долго думая, я предложил использовать 3 ключевых сетевых технологии и отсутствие кластеризации со стороны DPI устройств:
...
В следствии чего, мы приняли решение, что масштабирование конечно будет горизонтальным, чтобы достичь требуемой емкости, а резервирование DPI устройств будет N+1. Этого будет достаточно для абсорбирования возможных всплесков трафика или при ожидании поставки оборудования для требуемого расширения емкости. Конечно, в этом случае мы можем потерять резервирование, поэтому, в идеале, резервирование должно быть N+2, но реальный мир суров и не все можно сделать так, как хочешь именно ты.
