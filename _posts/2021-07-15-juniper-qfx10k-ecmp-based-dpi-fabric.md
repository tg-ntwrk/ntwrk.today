...
* QSFP28 - отдельно отличился их производитель (3rd party), в один день вышло из строя сразу несколько приемопередатчиков - гарантийный случай, спасло резервирование от двойного отказа, заменили всю партию приемопередатчиков.
...
* Спасибо Ярославу Капсалову за идеи и правки структуры заметки.
